...
<div class="block block-rounded">
    ...
    <div class="block-content">
        <form action="{{route('mark_sheet.update',['id'=>$id])}}" method="POST">
            @csrf
            @method('PATCH')
            <!-- Basic Elements -->
            ...
            <div class="row push">
                <div class="col-lg-12 col-xl-5">
                    <div class="mb-4">
                        ...
                        <select class="form-select" name="student_id" id="example-select-floating" name="example-select-floating" aria-label="Floating label select example" required>
                            ...
                            <option value="{{$student->id}}" {{ $data->student_id==$student->id?'selected':'' }}>{{ucfirst($student->name)}}</option>
                            @endforeach
                ...
                <div class="col-lg-12 col-xl-5">
                    <div class="mb-4">
                        ...
                        <select class="form-select" name="term" id="example-select-floating" name="example-select-floating" aria-label="Floating label select example" required>
                            ...
                            <option value="{{$key}}" {{ $data->term==$key?'selected':'' }}>{{ucfirst($term)}}</option>
                            @endforeach
                ...
                <div class="col-lg-12 col-xl-5">
                    <div class="mb-4">
                        ...
                        <input type="number" value="{{ Request::old('maths')??$data->maths }}" class="form-control" id="example-text-input" max="100" name="maths" placeholder="Maths">
                    </div>
                </div>
                <div class="col-lg-12 col-xl-5">
                    <div class="mb-4">
                        <label class="form-label" for="example-text-input">Science <span class="text-danger">*</span></label>
                        <input type="number" value="{{ Request::old('science')??$data->science }}" class="form-control" id="example-text-input" max="100" name="science" placeholder="Science">
                    </div>
                </div>
                <div class="col-lg-12 col-xl-5">
                    <div class="mb-4">
                        <label class="form-label" for="example-text-input">History <span class="text-danger">*</span></label>
                        <input type="number" value="{{ Request::old('history')??$data->history }}" class="form-control" id="example-text-input" max="100" name="history" placeholder="History">
                    </div>
                </div>
            </div>
            <div class="row push">
