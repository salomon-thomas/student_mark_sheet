                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{{route('student.edit',['id'=>$temp->id])}}" class="btn btn-sm btn-alt-secondary" data-bs-toggle="tooltip" title="Edit">
                                    <i class="fa fa-pencil-alt"></i>
                                </a>
                                <div class="btn-group">
                                    <a href="{{route('student.delete',['id'=>$temp->id])}}" onclick="return confirm(' Do you wish to delete?');" class="btn btn-sm btn-alt-secondary" data-bs-toggle="tooltip" title="Delete">
