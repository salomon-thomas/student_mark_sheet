            ...
            <div class="row push">
                <div class="col-lg-12 col-xl-5">
                    <div class="mb-4">
                        ...
                        <input type="text" value="{{ Request::old('name') }}" class="form-control" id="example-text-input" name="name" placeholder="Name">
                    </div>
                </div>
                <div class="col-lg-12 col-xl-5">
                    <div class="mb-4">
                        <label class="form-label" for="example-text-input">Age <span class="text-danger">*</span></label>
                        <input type="number" value="{{ Request::old('age') }}" class="form-control" id="example-text-input" name="age" placeholder="Age">
                    </div>
                </div>
                <div class="col-lg-12 col-xl-5">
                    <div class="mb-4">
